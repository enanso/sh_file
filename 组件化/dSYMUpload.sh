...
#
# #
BUGLY_APP_ID="idvalue"
# #
BUGLY_APP_KEY="APP_KEY_Value"
# #
BUNDLE_IDENTIFIER="Bundel Id"
# Bugly服务域名
BUGLY_DSYM_UPLOAD_DOMAIN="BUGLY_DSYM_UPLOAD_DOMAIN"
...
if [ $BuildInXcode = "T" ]; then
    ...
    # 可以在此处直接设置BuglyAppID和BuglyAppKey，排除不常变参数的输入
    BUGLY_APP_ID="$1"
    BUGLY_APP_KEY="$2"
    BUNDLE_IDENTIFIER="$3"
    BUGLY_APP_VERSION="$4"
