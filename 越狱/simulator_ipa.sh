#!/bin/bash
#----------------------模拟器安装app----------------------
# 功能：使用模拟器安装编译后的.app应用，真机测试设备不足时，使用模拟器安装测试
# 将x-code工程中模拟器下编译后的.app文件导出（位于工程Products文件夹）
# 操作2种方法：1.配置APP_PATH与脚本文件夹下的app名称，如:test.app；
#            2.终端执行：sh simulator_ipa.sh "~/Desktop/simulator/test.app"
# 作者 ：JABase
#-----------------------------------------------------------------------
